      ...
      {isMobile ? (
        ...
        <div className="navbar-menu-container">
          <ul className="navbar-menu">
            ...
            <li className="navbar-item">
              <NavLink to="/personal-area" activeClassName="active">Profilo</NavLink>
            </li>
            {userData?.role === 'admin' && (
              <li className="navbar-item">
                <NavLink to="/admin-dashboard" activeClassName="active">Dashboard Admin</NavLink>
              </li>
            )}
            {userData?.role === 'company' && userData?.status === 'approved' && (
              <>
                <li className="navbar-item">
                  <NavLink to="/sell-product" activeClassName="active">Vendi</NavLink>
                </li>
                <li className="navbar-item">
                  <NavLink to="/received-orders" activeClassName="active">Ordini ricevuti</NavLink>
                </li>
              </>
            )}
            {userData?.role === 'user' && (
              <li className="navbar-item">
                <NavLink to="/orders" activeClassName="active">Ordini</NavLink>
              </li>
            )}
            {!currentUser && (
              <li className="navbar-item">
