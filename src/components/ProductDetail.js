...
function ProductDetail() {
  ...
  return (
    <div className="product-detail">
      ...
      {/* Spostiamo il pulsante qui sotto l'immagine del prodotto */}
      {currentUser && userData?.role === 'user' ? (
        <div data-test="mms-cta-basket-wishlist" className="div-add-to-cart">
          <button onClick={addToCart} className="add-to-cart-button">
            ...
            <span className="sc-f52d4e87-0 dzLmYX">Aggiungi al carrello</span>
            <span className="sc-ad0ca069-0 ewEseA"></span>
          </button>
        </div>
      ) : (
        <p className="messaggio-accedi">Registrati o accedi come utente per aggiungere al carrello</p>
      )}
